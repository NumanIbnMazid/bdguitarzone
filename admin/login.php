...
<body class="bg-dark">
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <form method="post" action="../adminChecker.php">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="code" id="exampleInputPassword1" type="password" placeholder="Enter Your Secret Code..." required=" ">
          </div>
