        ...
        <div class="container">
            ...
            <div class="row cart-body">
                ...
                <div class="form-horizontal" style="margin: auto;
                    ...
                    <div class="panel panel-info" style="background-color: rgb(224, 240, 255);">
                        <div class="panel-heading"> Provide Your Personal Information</div>               
                        <div class="panel-body">

                        <span style="font-size: 18px; font-weight: 700; color: blue; margin-bottom: 10px;"><i class="fa fa-exclamation-triangle" aria-hidden="true">
                            ...
                            <!-- age -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="age" id="age" placeholder="Age..."onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" required=" "  class="form-control" value="<?php echo $age?>" />
                                    </div>
                                </div>
                            <!-- address -->
                                <div class="form-group">
                            ...
                            <!-- Postal Code -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" name="post_cd" id="post_cd" placeholder="Postal Code..." onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" required=" " class="form-control" value="<?php echo $post_cd ?>" />
                                    </div>
                                </div>
                            <!-- mobile -->
                                <div class="form-group">
                                ...
                                <div class="form-group" >
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        style= "margin: auto;
                                                width: 60%;
                                                border: 1.5px solid #757575;
                                                padding: 10px;">Update Account</button>
                                    </div>
                                </div>
                            </div>                               
                        </div>
            ...
            echo("<script>location.href = 'profile.php?user-id=$user_id;'</script>");  
                    //echo $sql;exit;
                    include_once 'dbCon.php';
                    $con = connect();
